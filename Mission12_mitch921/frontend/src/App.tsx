...
//here is all of the team info in JSON form:
const teamInfo = [
  {
    tid: 159,
    cid: 0,
  ...
  render() {
    return (
      <div>
        <h1>Welcome!</h1>
        <h2>
          This is a page with info on the NCAA Division I men's college
          basketball programs
        </h2>
      </div>
    );
...
//interface that fixed an error I was having with the TeamCard component (thanks ChatGPT)
interface TeamProps {
  tid: number;
  cid: number;
  did: number;
  ...
  render() {
    ...
    return (
      <div>
        <h3>{myTeam.school}</h3>
        <ul>
          <li>Mascot: {myTeam.name}</li>
          <li>
            Location: {myTeam.city}, {myTeam.state}
          </li>
        </ul>
      </div>
    );
...
//this component lists the teams
